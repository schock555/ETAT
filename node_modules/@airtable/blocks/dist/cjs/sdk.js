...
function () {
  ...
  function BlockSdk(airtableInterface) {
    ...
    this.performRecordAction = new _perform_record_action.PerformRecordAction(sdkInitData.baseData, airtableInterface);
...
(0, _defineProperty2.default)(BlockSdk, "VERSION", "0.0.53");